 ...
 */
#ifndef GSPR6P0PLANE_GSPR6P0PLANEARRAY_H_
#define GSPR6P0PLANE_GSPR6P0PLANEARRAY_H_
...
#define R6P0_MAX_IMG_NUM 2
#define R6P0_MAX_OSD_NUM 2

namespace android {

class GspR6P0PlaneArray : public GspPlaneArray {
public:
  explicit GspR6P0PlaneArray(bool async);
  virtual ~GspR6P0PlaneArray();
...
private:
  ...
  int rotAdjust(struct gsp_r6p0_cfg_user *cmd_info, SprdHWLayer **LayerList);
  ...
  GspR6P0PlaneImage *mImagePlane[R6P0_IMGL_NUM];
  GspR6P0PlaneOsd *mOsdPlane[R6P0_OSDL_NUM];
  GspR6P0PlaneDst *mDstPlane;

  int mConfigIndex;
  struct gsp_r6p0_cfg_user *mConfigs;
  struct drm_gsp_r6p0_cfg_user *drm_mConfigs;

  struct gsp_r6p0_capability mCapability;
...
#endif // GSPR6P0PLANE_GSPR6P0PLANEARRAY_H_
