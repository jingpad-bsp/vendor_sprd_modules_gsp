...
#ifndef GSPR6P0PLANE_GSPR6P0PLANE_H_
#define GSPR6P0PLANE_GSPR6P0PLANE_H_
...
class GspR6P0Plane : public GspPlane {
public:
  GspR6P0Plane() {}
  virtual ~GspR6P0Plane() {}

protected:
  enum gsp_r6p0_img_layer_format imgFormatConvert(int f);

  enum gsp_r6p0_osd_layer_format osdFormatConvert(int f);
  ...
  bool isVideoLayer(enum gsp_r6p0_img_layer_format format);

  bool isVideoLayer(enum gsp_r6p0_osd_layer_format format);
