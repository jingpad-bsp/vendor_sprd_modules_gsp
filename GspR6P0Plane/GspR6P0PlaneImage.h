 ...
 */
#ifndef GSPR6P0PLANE_GSPR6P0PLANEIMAGE_H_
#define GSPR6P0PLANE_GSPR6P0PLANEIMAGE_H_
...
class GspR6P0PlaneImage : public GspR6P0Plane {
public:
  GspR6P0PlaneImage(bool async, bool odd, bool support_up_down, bool size,
                    uint16_t up, uint16_t down, const GspRangeSize &range);
  virtual ~GspR6P0PlaneImage() {}
  ...
  struct gsp_r6p0_img_layer_user &getConfig();
...
private:
  ...
  bool checkImgLayerFormat(enum gsp_r6p0_img_layer_format format);
  ...
  void configFormat(enum gsp_r6p0_img_layer_format format);
  ...
  bool checkFBC(uint32_t pitch, uint32_t height,
                enum gsp_r6p0_img_layer_format format, bool inFBC);
  ...
  struct gsp_r6p0_img_layer_user mConfig;
};
} // namespace android

#endif // GSPR6P0PLANE_GSPR6P0PLANEIMAGE_H_
