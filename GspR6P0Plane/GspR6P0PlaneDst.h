 ...
 */
#ifndef GSPR6P0PLANE_GSPR6P0PLANEDST_H_
#define GSPR6P0PLANE_GSPR6P0PLANEDST_H_
...
#define R6P0_DST_GSP_MMU_SIZE (16 * 1024 * 1024)

namespace android {

class GspR6P0PlaneDst : public GspR6P0Plane {
public:
  explicit GspR6P0PlaneDst(bool async, int max_gspmmu_size,
                           int max_gsp_bandwidth);
  virtual ~GspR6P0PlaneDst() {}

  bool adapt(SprdHWLayer **list, int count);

  struct gsp_r6p0_des_layer_user &getConfig();
...
private:
  enum gsp_r6p0_des_layer_format dstFormatConvert(int format);
  ...
  struct gsp_r6p0_des_layer_user mConfig;
...
#endif // GSPR6P0PLANE_GSPR6P0PLANEDST_H_
