 ...
 */
#ifndef GSPLITER2P0PLANE_GSPLITER2P0PLANEIMAGE_H_
#define GSPLITER2P0PLANE_GSPLITER2P0PLANEIMAGE_H_
...
class GspLiteR2P0PlaneImage : public GspLiteR2P0Plane {
public:
  GspLiteR2P0PlaneImage(bool async, bool odd, bool support_up_down, bool size,
                        uint16_t up, uint16_t down, const GspRangeSize &range);
  virtual ~GspLiteR2P0PlaneImage() {}
  ...
  struct gsp_lite_r2p0_img_layer_user &getConfig();
...
private:
  ...
  bool checkImgLayerFormat(enum gsp_lite_r2p0_img_layer_format format);
  ...
  void configFormat(enum gsp_lite_r2p0_img_layer_format format);
  ...
  struct gsp_lite_r2p0_img_layer_user mConfig;
};
} // namespace android
