 ...
 */
#ifndef GSPR4P0PLANE_GSPR4P0PLANEOSD_H_
#define GSPR4P0PLANE_GSPR4P0PLANEOSD_H_
...
class GspR4P0PlaneOsd : public GspR4P0Plane {
public:
  GspR4P0PlaneOsd(bool async, const GspRangeSize &range);
  virtual ~GspR4P0PlaneOsd() {}
  ...
  struct gsp_r4p0_osd_layer_user &getConfig();
...
private:
  ...
  void configFormat(enum gsp_r4p0_osd_layer_format format);
  ...
  bool checkFBC(uint32_t pitch, uint32_t height,
                enum gsp_r4p0_osd_layer_format format, bool inFBC);

  GspRangeSize mRangeSize;

  struct gsp_r4p0_osd_layer_user mConfig;
};
} // namespace android

#endif // GSPR4P0PLANE_GSPR4P0PLANEOSD_H_
