...
#ifndef GSPR4P0PLANE_GSPR4P0PLANE_H_
#define GSPR4P0PLANE_GSPR4P0PLANE_H_
...
class GspR4P0Plane : public GspPlane {
public:
  GspR4P0Plane() {}
  virtual ~GspR4P0Plane() {}

protected:
  //  enum gsp_addr_type bufTypeConvert(int flag);

  enum gsp_r4p0_img_layer_format imgFormatConvert(int f);

  enum gsp_r4p0_osd_layer_format osdFormatConvert(int f);
  ...
  bool isVideoLayer(enum gsp_r4p0_img_layer_format format);

  bool isVideoLayer(enum gsp_r4p0_osd_layer_format format);
...
#endif // GSPR4P0PLANE_GSPR4P0PLANE_H_
