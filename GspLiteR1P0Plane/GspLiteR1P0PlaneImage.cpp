...
void GspLiteR1P0PlaneImage::configPmargbMode(uint32_t blendMode) {
  struct gsp_lite_r1p0_img_layer_params *params = &mConfig.params;
...
void GspLiteR1P0PlaneImage::configEndian(native_handle_t *handle) {
  struct gsp_lite_r1p0_img_layer_params *params = &mConfig.params;
  struct gsp_layer_user *common = &mConfig.common;
  ...
  case HAL_PIXEL_FORMAT_YCrCb_420_SP:
    params->endian.uv_word_endn = GSP_LITE_R1P0_WORD_ENDN_3;
    break;
