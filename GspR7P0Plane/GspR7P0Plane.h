...
#ifndef GSPR7P0PLANE_GSPR7P0PLANE_H_
#define GSPR7P0PLANE_GSPR7P0PLANE_H_
...
class GspR7P0Plane : public GspPlane {
public:
  GspR7P0Plane() {}
  virtual ~GspR7P0Plane() {}

protected:
  enum gsp_r7p0_img_layer_format imgFormatConvert(int f);

  enum gsp_r7p0_osd_layer_format osdFormatConvert(int f);
  ...
  bool isVideoLayer(enum gsp_r7p0_img_layer_format format);

  bool isVideoLayer(enum gsp_r7p0_osd_layer_format format);
...
#endif // GSPR7P0PLANE_GSPR7P0PLANE_H_
