 ...
 */
#ifndef GSPR3P0PLANE_GSPR3P0PLANEOSD_H_
#define GSPR3P0PLANE_GSPR3P0PLANEOSD_H_
...
class GspR3P0PlaneOsd : public GspR3P0Plane {
public:
  GspR3P0PlaneOsd(bool async, const GspRangeSize &range);
  virtual ~GspR3P0PlaneOsd() {}
  ...
  struct gsp_r3p0_osd_layer_user &getConfig();
...
private:
  ...
  void configFormat(enum gsp_r3p0_osd_layer_format format);
  ...
  struct gsp_r3p0_osd_layer_user mConfig;
};
} // namespace android

#endif // GSPR3P0PLANE_GSPR3P0PLANEOSD_H_
