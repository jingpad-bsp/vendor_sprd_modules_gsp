...
#ifndef GSPR3P0PLANE_GSPR3P0PLANE_H_
#define GSPR3P0PLANE_GSPR3P0PLANE_H_
...
class GspR3P0Plane : public GspPlane {
public:
  GspR3P0Plane() {}
  virtual ~GspR3P0Plane() {}

protected:
  enum gsp_addr_type bufTypeConvert(int flag);

  enum gsp_r3p0_img_layer_format imgFormatConvert(int f);

  enum gsp_r3p0_osd_layer_format osdFormatConvert(int f);
  ...
  bool isVideoLayer(enum gsp_r3p0_img_layer_format format);

  bool isVideoLayer(enum gsp_r3p0_osd_layer_format format);
...
#endif // GSPR3P0PLANE_GSPR3P0PLANE_H_
