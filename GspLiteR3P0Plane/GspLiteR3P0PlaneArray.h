 ...
 */
#ifndef GSPLiteR3P0PLANE_GSPLiteR3P0PLANEARRAY_H_
#define GSPLiteR3P0PLANE_GSPLiteR3P0PLANEARRAY_H_
...
#define LITE_R3P0_MAX_IMG_NUM 1
#define LITE_R3P0_MAX_OSD_NUM 2

namespace android {

class GspLiteR3P0PlaneArray : public GspPlaneArray {
public:
  explicit GspLiteR3P0PlaneArray(bool async);
  virtual ~GspLiteR3P0PlaneArray();
...
private:
  ...
  bool osdPlaneParcel(SprdHWLayer **list, int OsdPlaneIndex, bool InputRotMode);
  ...
  GspLiteR3P0PlaneImage *mImagePlane[LITE_R3P0_IMGL_NUM];
  GspLiteR3P0PlaneOsd *mOsdPlane[LITE_R3P0_OSDL_NUM];
  GspLiteR3P0PlaneDst *mDstPlane;

  int mConfigIndex;
  struct gsp_lite_r3p0_cfg_user *mConfigs;
  struct drm_gsp_lite_r3p0_cfg_user *drm_mConfigs;

  struct gsp_lite_r3p0_capability mCapability;
...
#endif // GSPLiteR3P0PLANE_GSPLiteR3P0PLANEARRAY_H_
