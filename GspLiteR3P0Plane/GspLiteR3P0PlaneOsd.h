 ...
 */
#ifndef GSPLiteR3P0PLANE_GSPLiteR3P0PLANEOSD_H_
#define GSPLiteR3P0PLANE_GSPLiteR3P0PLANEOSD_H_
...
class GspLiteR3P0PlaneOsd : public GspLiteR3P0Plane {
public:
  GspLiteR3P0PlaneOsd(bool async, const GspRangeSize &range);
  virtual ~GspLiteR3P0PlaneOsd() {}
  ...
  struct gsp_lite_r3p0_osd_layer_user &getConfig();
...
private:
  ...
  void configFormat(enum gsp_lite_r3p0_osd_layer_format format);
  ...
  bool checkFBC(uint32_t pitch, uint32_t height,
                enum gsp_lite_r3p0_osd_layer_format format, bool inFBC);
  ...
  struct gsp_lite_r3p0_osd_layer_user mConfig;
};
} // namespace android

#endif // GSPLiteR3P0PLANE_GSPLiteR3P0PLANEOSD_H_
