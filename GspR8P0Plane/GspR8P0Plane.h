...
#ifndef GSPR8P0PLANE_GSPR8P0PLANE_H_
#define GSPR8P0PLANE_GSPR8P0PLANE_H_
...
class GspR8P0Plane : public GspPlane {
public:
  GspR8P0Plane() {}
  virtual ~GspR8P0Plane() {}

protected:
  enum gsp_r8p0_img_layer_format imgFormatConvert(int f);

  enum gsp_r8p0_osd_layer_format osdFormatConvert(int f);
  ...
  bool isVideoLayer(enum gsp_r8p0_img_layer_format format);

  bool isVideoLayer(enum gsp_r8p0_osd_layer_format format);
...
#endif // GSPR8P0PLANE_GSPR8P0PLANE_H_
