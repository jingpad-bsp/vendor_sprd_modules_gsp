 ...
 */
#ifndef GSPR8P0PLANE_GSPR8P0PLANEOSD_H_
#define GSPR8P0PLANE_GSPR8P0PLANEOSD_H_
...
class GspR8P0PlaneOsd : public GspR8P0Plane {
public:
  GspR8P0PlaneOsd(bool async, const GspRangeSize &range);
  virtual ~GspR8P0PlaneOsd() {}
  ...
  struct gsp_r8p0_osd_layer_user &getConfig();
...
private:
  ...
  void configFormat(enum gsp_r8p0_osd_layer_format format);
  ...
  bool checkFBC(uint32_t pitch, uint32_t height,
                enum gsp_r8p0_osd_layer_format format, bool inFBC);

  GspRangeSize mRangeSize;
  uint16_t mZorder;

  struct gsp_r8p0_osd_layer_user mConfig;
};
} // namespace android

#endif // GSPR8P0PLANE_GSPR8P0PLANEOSD_H_
