...
GspR8P0PlaneImage::GspR8P0PlaneImage(bool async, bool is_need_even,
  ...
  mZorder = 0;
  ALOGI("create GspR8P0PlaneImage");
  mRangeSize.print();
...
bool GspR8P0PlaneImage::checkVideoSize(struct sprdRect *srcRect) {
  bool result = true;
...
bool GspR8P0PlaneImage::checkOddBoundary(
    struct sprdRect *srcRect, enum gsp_r8p0_img_layer_format format) {
  bool result = true;
...
bool GspR8P0PlaneImage::needScaleUpDown(struct sprdRect *srcRect,
...
bool GspR8P0PlaneImage::checkScaleSize(struct sprdRect *srcRect,
                                       struct sprdRect *dstRect,
...
bool GspR8P0PlaneImage::checkScale(struct sprdRect *srcRect,
                                   struct sprdRect *dstRect,
                                   enum gsp_rot_angle rot, bool inFBC) {
...
bool GspR8P0PlaneImage::checkImgLayerFormat(
    enum gsp_r8p0_img_layer_format format) {
  bool result = true;

  if (format == GSP_R8P0_IMG_FMT_MAX_NUM) {
...
void GspR8P0PlaneImage::reset(int flag) {
  mAttached = false;
  mIndex = -1;
  mDebugFlag = flag;
  memset(&mConfig, 0, sizeof(struct gsp_r8p0_img_layer_user));
}

bool GspR8P0PlaneImage::checkFBC(uint32_t pitch, uint32_t height,
                                 enum gsp_r8p0_img_layer_format format,
                                 bool inFBC) {
  bool isAFBC = false;
  ...
  if (inFBC) {
    if ((GSP_R8P0_IMG_FMT_ARGB888 == format) ||
        (GSP_R8P0_IMG_FMT_RGB888 == format) ||
        (GSP_R8P0_IMG_FMT_RGB565 == format) ||
        (GSP_R8P0_IMG_FMT_YUV420_2P == format)) {
      isAFBC = true;
      if (GSP_R8P0_IMG_FMT_YUV420_2P == format) {
        horAlign = 32;
        verAlign = 8;
      } else {
        horAlign = 16;
...
bool GspR8P0PlaneImage::checkInputRotation(
  ...
  if (rot != 0) {
    switch (format) {
    case GSP_R8P0_IMG_FMT_YUV420_2P:
    case GSP_R8P0_IMG_FMT_YV12:
    case GSP_R8P0_IMG_FMT_ARGB888:
    case GSP_R8P0_IMG_FMT_RGB888:
    case GSP_R8P0_IMG_FMT_RGB565:
      break;
    default:
...
bool GspR8P0PlaneImage::adapt(SprdHWLayer *layer, int count, int LayerIndex,
                              bool InputRotMode) {
  ...
  enum gsp_r8p0_img_layer_format format = imgFormatConvert(ADP_FORMAT(handle));
...
void GspR8P0PlaneImage::configCommon(int wait_fd, int share_fd, int enable) {
...
int GspR8P0PlaneImage::get_tap_var0(int srcPara, int destPara) {
  int retTap = 0;
...
void GspR8P0PlaneImage::configScale(struct sprdRect *srcRect,
                                    struct sprdRect *dstRect,
                                    enum gsp_rot_angle rot) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
  uint32_t dstw = 0;
  uint32_t dsth = 0;
...
void GspR8P0PlaneImage::configSize(struct sprdRect *srcRect,
...
void GspR8P0PlaneImage::configFormat(enum gsp_r8p0_img_layer_format format) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
...
void GspR8P0PlaneImage::configFBC(bool inFBC, int format,
                                  native_handle_t *handle) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
  uint32_t fbc_mode;

  if (inFBC && ((GSP_R8P0_IMG_FMT_ARGB888 == format) ||
                (GSP_R8P0_IMG_FMT_RGB888 == format) ||
                (GSP_R8P0_IMG_FMT_RGB565 == format) ||
                (GSP_R8P0_IMG_FMT_YUV420_2P == format)))
    fbc_mode = 1;
...
void GspR8P0PlaneImage::configPmargbMode(uint32_t blendMode) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;

  if (blendMode == HWC_BLENDING_PREMULT || blendMode == HWC_BLENDING_NONE)
    params->pmargb_mod = 1;
  else
    params->pmargb_mod = 0;
...
void GspR8P0PlaneImage::configAlpha(uint8_t alpha) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
...
void GspR8P0PlaneImage::configCSCMatrix(native_handle_t *handle) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
  uint8_t y2r_mod = 3;
...
void GspR8P0PlaneImage::configY2Y(uint8_t y2y_mod) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
...
void GspR8P0PlaneImage::configZorder(uint8_t zorder) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
...
void GspR8P0PlaneImage::configEndian(native_handle_t *handle) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;
  struct gsp_layer_user *common = &mConfig.common;
  ...
  case HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED:
    params->endian.uv_word_endn = GSP_R8P0_WORD_ENDN_3;
    break;
...
void GspR8P0PlaneImage::configInputRot(enum gsp_rot_angle rot) {
  struct gsp_r8p0_img_layer_params *params = &mConfig.params;

  params->rot_angle = rot;
  ALOGI_IF(mDebugFlag, "config input rotation : 0x%d", rot);
}
struct gsp_r8p0_img_layer_user &GspR8P0PlaneImage::getConfig() {
  return mConfig;
}

bool GspR8P0PlaneImage::parcel(SprdHWLayer *layer, bool InputRotMode) {
  if (layer == NULL) {
...
bool GspR8P0PlaneImage::parcel(uint32_t w, uint32_t h) {
