 ...
 */
#ifndef GSPR8P0PLANE_GSPR8P0PLANEARRAY_H_
#define GSPR8P0PLANE_GSPR8P0PLANEARRAY_H_
...
#define R8P0_MAX_IMG_NUM 2
#define R8P0_MAX_OSD_NUM 2

namespace android {

class GspR8P0PlaneArray : public GspPlaneArray {
public:
  explicit GspR8P0PlaneArray(bool async);
  virtual ~GspR8P0PlaneArray();
...
private:
  ...
  int rotAdjust(struct gsp_r8p0_cfg_user *cmd_info, SprdHWLayer **LayerList);
  ...
  GspR8P0PlaneImage *mImagePlane[R8P0_IMGL_NUM];
  GspR8P0PlaneOsd *mOsdPlane[R8P0_OSDL_NUM];
  GspR8P0PlaneDst *mDstPlane;

  int mConfigIndex;
  struct gsp_r8p0_cfg_user *mConfigs;
  struct drm_gsp_r8p0_cfg_user *drm_mConfigs;

  struct gsp_r8p0_capability mCapability;
...
#endif // GSPR8P0PLANE_GSPR8P0PLANEARRAY_H_
